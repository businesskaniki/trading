...
const riskSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchRiskProfile.pending, (state) => { state.loading = true; state.error = null; })
      .addCase(fetchRiskProfile.fulfilled, (state, action) => { state.loading = false; state.profile = action.payload; })
      .addCase(fetchRiskProfile.rejected, (state, action) => { state.loading = false; state.error = action.payload; })
