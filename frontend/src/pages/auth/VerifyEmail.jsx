...
import { verifyEmail, resendOTP } from "../../redux/auth/authThunks";
...
const VerifyEmail = () => {
  ...
  const { loading, error, success, pendingVerificationEmail } = useSelector(
    (state) => state.auth,
  );
  ...
  return (
    <div className="verify-page">
      <Paper shadow="lg" radius="md" p="xl" className="verify-card">
